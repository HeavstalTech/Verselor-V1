...
## Updated
- update *script/repo* command to include deployment video tutorial link
- update README.md to include*deployment video tutorial* section

---
## [1.5.1] - 2026-06-16

## Updated
- Updated Gideon to be twice as fast, more efficient, with more information, and with web search capabilities for premium users
- update markOnlineOnConnect to false to keep user online status ass off by default

## Added 
- Added a new **online** command to change users online status
- Added New set of storage based commands

## Removed 
- Removed All WaBan and Unban Commands

---
## [1.4.2] - 2026-05-21

### Updated
- Updated method of communication with Heavstal Tech APIa to reduce complexity and maximize performance 

### Fixed
- Fixed **Play, play2, Spotify, Shazam, ytsearch, ytmp3, ytmp4** commands

---
## [1.4.1] - 2026-05-14

### Added
- Added **StopRentBot** function for more efficient closing of RentBot sessions

### Updated
- Updated start.js and rentbot.js - made connection more stable
- Updated **delpair** command to use the **StopRentBot** function
- Updated **status monitoring** to include autoread and autoreact (configurable)
- Updated AI agent to be more human-like

### Fixed
- fixed admin detection logic to work properly now

### Added
- Added more commands to menu
...
- removed a module in respective of an alternative 

### Updated
- update cahches

### Added
- added new Todo List (collaborators feel free to help)
- added new module 
## [1.3.11] - 2026-04-21

### Updated
- Updated multiple commands and features to clear Buffer ans Temp files to prevent OOM/SIGKILL errors on low end servers
- Updated ffmpeg to he more consistent
- Updated and make multiple file more Open-Source
...
### Updated
- Update makeInMemoryStore function to prevent OOM/SIGKILL errors on low end end servers like katabump
...
## Updated 
- Changed Our Main Third-party domain to "https//bots.heavstal.com.ng" to prevent bot from crashing - Note: all bots must use this version as old verison will try to featch dsta from the old and get a 301 redirect error ad it is a POST endpoint.
