...
export default [
    ...
    },
    {
        ...
        execute: async (HeavstalTech, m, context) => {
            ...
            try {
                ...
                const enhancedImageBuffer = await upscaleImage(mediaBuffer, 'enhance'); // Ensure 'enhance' is passed
    ...
    },
    {
        ...
        execute: async (HeavstalTech, m, context) => {
            ...
            Vreply(context.mess.wait);
            try {
                const { fetchJson } = await import('#System/Data1.js');
    ...
    },
    {
        ...
        execute: async (HeavstalTech, m, context) => {
            ...
            try {
                await HeavstalTech.sendImageAsSticker(m.chat, imageUrl, m, { packname: global.packname, author: global.author });
            } catch (err) {
