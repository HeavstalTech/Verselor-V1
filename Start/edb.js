...
/**
 * Dummy connect function so `start.js` doesn't throw an error 
 * when it tries to run `edb.connect()`
 */
async function connect(uri) {
    console.log("Local LowDB Economy System Initialized Successfully.");
